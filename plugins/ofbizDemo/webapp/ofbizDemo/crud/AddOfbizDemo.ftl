...
<#--        <input type="text" name="firstName" class="required" maxlength="20"/>-->
<#--      </div>-->
<#--      <div>-->
<#--        <span class="label">${uiLabelMap.OfbizDemoLastName}</span>-->
<#--        <input type="text" name="lastName" class="required" maxlength="20"/>-->
<#--      </div>-->
<#--    </fieldset>-->
...
<#-- 커스텀 데코 적용 -->
<form method="post" action="<@ofbizUrl>createOfbizDemoEventFtl</@ofbizUrl>" name="createOfbizDemoEvent"
